# clientes = ["Julian","Reynel","alejandro","Melchor","Juan","Anamilena","DAVID","Suleica","Camila","Gaspar","DAVID","Valtazar","Melchor","Juan"]
# print (clientes)
# clientes.append ("JULIANA")
# Cantidad = len(clientes)
# print (f"la cantidad de elementos en lista es de {Cantidad}")
# print(f"el menor nombre alfabetico es {min(clientes)} y el mayor numero alfabeticamente es {max(clientes)}")
num = [1,2,3,2]
num[3] = 4
num.remove(4)
print (num)

print(Era un pueblecito rayano, Ribamoura, vivero de contrabandistas, donde esta profesión de riesgo y lucro hacía a la gente menos dormida de lo que suelen ser los pueblerinos. Abundaban los mozos de cabeza caliente, y se desdeñaba al que no era capaz de coger una escopeta y salir a la ganancia.
