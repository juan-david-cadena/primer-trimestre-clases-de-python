# eje1 = "el conocimiento es poder"
# print (eje1.find("conocimiento"))
# print (eje1.find("poder"))

# #punto 2

# eje2 = "la practica hace al maestro"
# print (eje2.find("practica"))
# print (eje2.find("maestro"))

# #punto3

# eje3 = input("ingresa una frase ")
# eje3_2 = input("ingrese la palabra a buscar ")
# print (eje3.find(eje3_2))
...
# print(texto1.find("Sabia"))
# print(texto1.find("Caminaba")) 
# print (texto1.find("falanges"))
# print (texto1[379:654])
...
# print(texto2.find("piedra"))
# print(texto2.find("Pequeños")) 
# print (texto2.find("area"))
# print (texto2[466:541])
